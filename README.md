...
1. Download the [latest release](https://github.com/sublipri/kobo-wifi-remote/releases/download/v0.3.2/KoboWiFiRemote-0.3.2.zip) and extract the `.zip` file.
